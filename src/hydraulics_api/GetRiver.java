...
public class GetRiver {
	...
	public static void getRiver() throws Exception {
		...
		File file = new File("/home/chkusr/TEST_DATA/HydraulicsService_getRiver_" + strDate + ".dat");
		...
		File f = new File("/home/chkusr/TEST_DATA/HydraulicsService_getRiver_" + strDate + ".dat");
